...
def write():
    ...
    st.write(f"We are looking at a picture of person nummber {person_number} with image number {file_number}.")
    ...
    st.image(bbox_image, caption="Random picture with bounding boxes", use_column_width=True)
