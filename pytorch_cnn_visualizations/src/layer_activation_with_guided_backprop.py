...
class GuidedBackprop():
    ...
    def hook_layers(self):
        ...
        first_layer = list(self.model.model._modules.items())[0][1]
    ...
    def update_relus(self):
        ...
        for pos, module in self.model.model._modules.items():
...
if __name__ == '__main__':
    cnn_layer = 23
    filter_pos = 5
    target_example = 0  # Yellow balloon
